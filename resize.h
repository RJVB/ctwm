...
extern void ConstrainSize ( TwmWindow *, int*, int* );

#ifdef _HAVE_XINERAMA_
extern unsigned int theDisplayWidth( int x_offset, int y_offset, int *base_x, int *base_y, int *head );
extern unsigned int theDisplayHeight( int x_offset, int y_offset, int *base_x, int *base_y, int *head );
#endif
