...
extern int CTWMParseGeometry( char *parsestring, int *x_return, int *y_return, unsigned int *width_return, unsigned int *height_return );
#ifdef _HAVE_XINERAMA_0
#	define XParseGeometry(s,x,y,w,h)	CTWMParseGeometry((s),(x),(y),(w),(h))
#endif
